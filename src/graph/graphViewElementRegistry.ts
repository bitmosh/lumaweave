...
export const graphViewElements: GraphViewElement[] = [
  ...
  },
  {
    ...
    status: "active",
    evidenceKind: "dom-wrapper",
    testSelector: "setting-physics-nodeSize, setting-physics-linkDistance, setting-physics-repelForce",
  ...
  },
  {
    id: "graph.physics",
    title: "Graph Physics",
    description: "Physics settings including node size, link distance, and repel force",
    category: "control",
    status: "active",
    evidenceKind: "dom-wrapper",
    testSelector: "setting-physics-nodeSize, setting-physics-linkDistance, setting-physics-repelForce",
