...
export const handlesetRegistry: HandlesetRegistry = {
  ...
  entries: [
...

    {
      ...
      binding: {
        sourceFile: "src/control-plane/settings/settings.schema.ts",
        runtimeTarget: "src/graph/renderers/sigma2d/SigmaGraphView.tsx gwells controller",
        liveUpdate: true,
...

    {
      ...
      label: "Node Size (Retired)",
      category: "Graph View",
      defaultValue: 1.0,
      controlType: "range",
      status: "retired",
      retiredAt: "vP-physics-gwells-integration",
      retiredReason: "FA2 physics replaced by gwells. Node size now controlled at graph level, not physics level.",
      binding: {
