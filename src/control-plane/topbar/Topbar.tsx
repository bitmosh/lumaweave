  ...
  return (
    <header className="lw-topbar" data-lw-theme-target="topbar.root">
      ...
      <div className="lw-topbar-right">
        ...
        <div className="lw-topbar-toggle-stack">
          <PillToggle
            label={t("topbar.toggle.animation")}
            value={settings.appearance.animationEnabled}
            onChange={(v) => setSetting("appearance.animationEnabled", v)}
            testId="topbar-toggle-animation"
          />
          <PillToggle
            label={t("topbar.toggle.reduceMotion")}
            value={settings.appearance.reduceMotion}
            onChange={(v) => setSetting("appearance.reduceMotion", v)}
            testId="topbar-toggle-reduce-motion"
          />
        </div>
        <button
          type="button"
        ...
        >
          <svg className="lw-icon-gear" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
