 ...
 * 
 * Contract: docs/control-plane/SYSTEM_INDEX_REGISTRY_CONTRACT.md
 */
...
const SYSTEM_INDEX_ENTRIES: readonly SystemIndexEntry[] = [
  ...
  },
  {
    ...
    status: "accepted",
    lifecycle: "accepted",
    docPaths: ["docs/control-plane/SYSTEM_INDEX_REGISTRY_CONTRACT.md"],
    sourcePaths: [],
    testPaths: ["tests/e2e/contract-registry.spec.ts"],
    qaKeys: ["v72"],
    acceptedPasses: ["v72a"],
  ...
  },
  {
    ...
    status: "current",
    lifecycle: "accepted",
    docPaths: ["docs/control-plane/GRAPH_CONTROL_PLANE_NAVIGATION_CONTRACT.md"],
  ...
  },
  {
    ...
    forbiddenBoundaries: ["no theme mutation without lock/pin stability"],
    relatedSystems: [],
  ...
  },
  {
    ...
    forbiddenBoundaries: ["no music reactivity before Motion Safety proven"],
    relatedSystems: [],
