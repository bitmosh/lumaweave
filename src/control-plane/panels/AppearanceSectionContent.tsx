 ...
 *
 * Renders the Graph View category's body content. Used in two places:
 * - SettingsPanel (when not tiled out)
 * - FloatingTile via tileSectionRegistry (when tiled out)
 *
 * Note: category display name is "Graph View" but registry id is
 * "appearance-section". Single source of truth, same pattern as
...
export function AppearanceSectionContent() {
  ...
  return (
    <section
      ...
      data-testid="appearance-section-content"
    >
