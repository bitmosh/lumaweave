...
> existing dialect concept is Galaxy Mode (`docs/physics/GALAXY_MODE_DIALECT.md`).
>
...
- Add cluster-based layout algorithms (implemented as gwells dialects — e.g., the Galaxy Mode dialect at `docs/physics/GALAXY_MODE_DIALECT.md`)
