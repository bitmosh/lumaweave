...
title: Progressive Neighborhood Depth Slider
type: concept
status: concept
cluster: azure
domain: graph
...
references:
  - graph.cluster.gravity.and.color.coded.neighborhoods
  - graph.visual.policy
  - layout.top.bar.control.plan
tags: [graph, depth, slider, neighborhood, traversal, future, concept]
---
