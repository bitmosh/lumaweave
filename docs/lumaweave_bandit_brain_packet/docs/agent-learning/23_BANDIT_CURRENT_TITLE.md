...
- v57+: Promote to token value application (if governance permits)
- v57+: Promote to Sigma/renderer mutation (if governance permits)
- v57+: Promote to node/edge/canvas styling (if governance permits)
- Continue respecting all forbidden boundaries until explicitly promoted
