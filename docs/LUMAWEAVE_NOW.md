...
| v103.1.4 | Unified tile creation (createDefaultTile helper) + reconcile missing default-visible tiles each load; graph-sources + graph-inspector now appear and toggle correctly; tileOut well-formed (mode/anchor/visible) | in-progress |
