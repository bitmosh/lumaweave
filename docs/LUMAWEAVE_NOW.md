...
| v103.0.1 | Cluster-color resolver: `loadClusterColors()` + `resolveClusterColor()` (semantic mode), pure/theme-independent, direct docs/_meta JSON import, 4 Playwright unit tests, NO render wiring | in-progress |
