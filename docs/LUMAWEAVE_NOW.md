...
| v103.1.1 | Wire resolveLivePosition into render + snap/group + resize: resolvedTilesArray upstream in TileLayer, getLiveTiles resolves, debounced resize listener, docked→floating flip on drag; stranded tiles now visible | in-progress |
