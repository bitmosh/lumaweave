// minimap-viewport-rect.jsx
// → MinimapViewportRect.tsx in real app
//
// Pure presentation. Position comes from useMinimapCamera as %s.
// Colors via oklch relative-color so the rect stays in the warm
// family with any theme.

function MinimapViewportRect({ rect }) {
  if (!rect) return null;
  return (
    <div
...
Object.assign(window, { MinimapViewportRect });
